...
/* 
Template Name: Country Embassy Abroad
*/
...
<div id="otherpage">
    <div class="inner-wrap">
        ...
        <div id="c2">
            ...
            <h2><?php echo $countryname; ?> Embassies Abroad</h2>
            
            <?php
			
				$wpq = array ('post_type' => 'embassy', 'orderby' => 'name', 'order' => 'desc', 'embassies_area' => $countryname . '-abroad', 'post_status' => 'publish', 'paged' => $paged, 'posts_per_page' => 6);
            ...
            <?php else : ?>
            <div>
                   <p>Sorry, We will update all <?php echo $countryname; ?> embassies abroad soon.</p>
            </div>
