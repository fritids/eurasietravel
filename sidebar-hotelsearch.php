<div id="c1">	
	...
	<div class='grid_4'>
		<div class="box radius">
			<div class="padded">
				<h2 class="purple radius"><strong>3 Top</strong> Tour in <?php echo $countryname; ?></h2>                                
                
				<?php
                    $top_destination = 'Top Destination';					 
                    query_posts("showposts=3&post_type=tours&tour_top=$countryname");				
                ...
                <div class="top-hotel-items">
                    ...
                    <div class="hotel-short-info">
                        ...
                        <span>Pirce: <?php echo format_listing_price($tourminiprice) ?></span>                                
                    </div>   
                    <div class="clear"></div>
                </div>
                <!--End Hotel Items-->
				...
				?>
				<div class="top-hotel-items">
	                <p>Sorry, This coutnry destination will coming soon!</p>
                </div>
                <?php
